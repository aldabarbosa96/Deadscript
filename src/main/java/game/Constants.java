...
public final class Constants {
    ...
    public static boolean UPPER_OVERLAY_ACTIVE = false;


    // Player
    public static final long PLAYER_MOVE_COOLDOWN_NS = 180_000_000L; // ≈5.55 tiles/s
    public static final int FOV_OUTER_EXTRA = 2;
    public static final double SPRINT_SPEED_MULT = 1.75;
    public static final double WALK_STEP_ENERGY_COST = 0.01;
    public static final double SPRINT_ENERGY_MULT = 8;
    ...
    public static final long RENDER_MIN_INTERVAL_NS = 16_000_000L;
